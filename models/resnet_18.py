from tensorflow.keras.layers import Input, MaxPooling2D, AveragePooling2D, Conv2D, BatchNormalization, Activation, Add, Flatten, Dense
...
class Resnet18:
    ...
    def convolutional_block(self, input_tensor, filters, activations, stage, block, start_with_batch_norm = True):
        """
    ...
    def build_network(self):
        ...
        x = self.identity_block(x, 512, 'relu', 5, 'b')
