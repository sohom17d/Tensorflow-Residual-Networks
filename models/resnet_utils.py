...
def main_path_block(x, filters, kernel_size, padding, conv_name, bn_name, activation = None, strides = (1, 1)):
    """
...
def convolutional_block(input_tensor, middle_filter_size, filters, stage, block, stride = 2):
    """
    Implementation of Identity Block
